/*  src/pages/Admin/Marketing/Marketing.tsx  */
import {
  Box,
  Paper,
  TextField,
...
/* ─────── 4) page component ─────── */
export default function MarketingActivePage() {
  ...
  const create = async () => {
    ...
    try {
      ...
      ).unwrap(); // <- throws on error → catch below
      setOk(t("campaign_created")); // 🔔 success
      setTimeout(() => setOk(""), 3000); // auto-hide
      /* form reset */
      setCode("");
      setLink("");
      setType("");
